package fr.noobtopia.plugin.features.mob.mana.commands;
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        if(sender instanceof Player player){
            ...
            inventory.setItem(43, new ItemBuilder(Material.ARROW).displayName("§aMana du Vent")
                    .lore("§e" + Mana.get(player, ManaType.WAR) + "§a manas de Vent")
                    .lore("§e" + Mana.get(player, ManaType.CURSED_WAR) + "§a manas de Vent maudits")
                    .build());
