...
public class CustomDrowned extends CustomEntity {
    public CustomDrowned(Drowned entity, boolean boss){
        super(entity, boss);
        ...
        entity.setCustomName((boss ? "§9" : "§1") + "Noyé n. §e" + this.level);
    ...
    private static final ItemStack[] LEATHER_SET = {
            ...
            new ItemBuilder(TRIDENT).enchant(IMPALING, 1).build(),
